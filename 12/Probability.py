    ...
    for sx in range(40):
        ...
        for n in range(2, len(dice) + 2):
            ...
            if current == 30: # G2J
                ...
                # r은 5, 15, 25, 35
                if current == 7: probTransitionSx[15] += probability * (2 / 16)
                elif current == 22: probTransitionSx[25] += probability * (2 / 16)
                elif current == 36: probTransitionSx[5] += probability * (2 / 16)
                # u는 12, 28
                if current == 7 or current == 36: probTransitionSx[12] += probability * (1 / 16)
